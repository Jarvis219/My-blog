...
const defaultMeta = {
  title: 'Blogger - A blog platform for everyone',
  siteName: 'Blogger - A blog platform for everyone',
  description:
    'Blogger is a blog platform for everyone. Write, share, and discover the latest news and articles.',
